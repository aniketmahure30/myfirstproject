<%@ Page Language="C#" AutoEventWireup="true" CodeFile="bed.aspx.cs" Inherits="bed" %>
...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container-fluid border bg-light ">
        <div class="row">
            ...
            <div class="col-lg-2 text-center">
                    ...
                    <a class="text-dark active" href="empty.aspx"> DECOR</a>
            </div>
            <div class="col-lg-2 text-center">
                   
                    <a class="text-dark active" href="empty.aspx"> Living</a>
            </div>
            <div class="col-lg-2 text-center">
                    <a class="text-dark active" href="empty.aspx">Bedroom </a>
            </div>
            <div class="col-lg-2 text-center">
                    <a class="text-dark active" href="empty.aspx">Homeware</a>
                    
            </div>
            <div class="col-lg-2 text-center">
                    <a class="text-dark active" href="empty.aspx">Gifting </a>
    ...
    <!--beds multiple  option page with basic detials -->
    ...
    <div class="container mt-4">
                    <div class="row">
                                    ...
                                    <div class="col">
                                    <a href="#"><img alt="img" src="images/bedsoption/bb.webp" /></a>
                                    <h5 class="text-dark">Yuuna King Size Bed With Storage In Wenge Finish</h5>                                
                                    <p class="text-muted">by Mintwud</p>    
                                    <strong>  Rs.17,999 </strong>Rs.<strike>38,999</strike>
                                    <p class="text-muted" Save Rs.21,000 </p><p class="text-danger">(54% Off)</p><p class="text-muted"> Limited Time Offer</p>
                                    <p class="text-info">  Extra Cashback Worth Rs.4,500.</p>
                                    <button type="button" class="btn btn-warning">Add to Cart</button>
                                    </div>
                                        
                                    
                                    <div class="col">
                                    <a href="#"> <img alt="img" src="images/bedsoption/bbb.webp" /></a>     
                                    <h5>Kosmo Crescent Queen Size Bed With Storage In Shadow Oak & Moldau Akazia Finish</h5>                                    
                                    <p class="text-muted"><a>by Spacewood</a></p>    
                                    <strong>Rs.16,799</strong> Rs.<strike>23,314</strike>
                                    <p class="text-muted"> Save Rs.21,000 </p><p class="text-danger">(28% Off)</p><p class="text-muted"> Limited Time Offer</p>
                                    <p class="text-info">  Extra Cashback Worth Rs.4,200.</p>
                                    <button type="button" class="btn btn-warning">Add to Cart</button>
                                    </div>
                                    
                
                                    <div class="col">
                                    <a href="#"> <img alt="img" src="images/bedsoption/bbbb.jpg" /> </a>
                                    <h5 class="text-dark">Kosmo Weave King Size Bed With Storage In Vermount Finish</h5>
                                    <p class="text-muted"><a>by Spacewood</a></p>    
                                    <strong> Rs.21,937 </strong> Rs.<strike>29,250</strike>
                                    <p class="text-muted"> Save Rs.7,313 </p><p class="text-danger">(25% Off)</p><p class="text-muted"> Limited Time Offer</p>
                                    <p class="text-info">  Extra Cashback Worth Rs.5,485.</p>
                                    <button type="button" class="btn btn-warning">Add to Cart</button>
                                    </div>
                                    ...
                                    <div class="col">
                                    <a href="#"> <img alt="img" src="images/bedsoption/bbbbb.webp"/></a>
                                    <h5 class="text-dark">Takeo Single Bed In Walnut Finish</h5>
                                    <p class="text-muted"><a>by Mintwud</a></p>    
                                    <strong>Rs.8,299</strong> Rs.<strike>17,697</strike>
                                    <p class="text-muted"> Save Rs.9,398 </p><p class="text-danger">(53% Off)</p><p class="text-muted"> Limited Time Offer</p>
                                    <p class="text-info">  Extra Cashback Worth Rs.2,075.</p>
                                    <button type="button" class="btn btn-warning">Add to Cart</button>
                                     </div>
                                    
                                    <div class="col">
                                    <a href="#"> <img alt="img" src="images/bedsoption/bd.webp" /> </a>
                                    <h5 class="text-dark">Takeo double Bed focuss Finish</h5>
                                    <p class="text-muted"><a>by Mintwud</a></p>    
                                    <strong>Rs.17,299</strong> Rs.<strike>25,697</strike>
                                    <p class="text-muted"> Save Rs.8,85 </p><p class="text-danger">(48% Off)</p><p class="text-muted"> Limited Time Offer</p>
                                    <p class="text-info">  Extra Cashback Worth Rs.2,075.</p>
                                    <button type="button" class="btn btn-warning">Add to Cart</button>
                                    </div>
                                    ...
                                    <div class="col">
                                    <a href="#"> <img alt="img" src="images/bedsoption/bfb.webp" /></a>
                                    <h5 class="text-dark">Takeo Single Bed In Walnut Finish</h5>
                                    <p class="text-muted"><a>by Mintwud</a></p>    
                                    <strong>Rs.6,299</strong> Rs.<strike>15,697</strike>
                                    <p class="text-muted"> Save Rs.7,398 </p><p class="text-danger">(45% Off)</p><p class="text-muted"> Limited Time Offer</p>
                                    <p class="text-info">  Extra Cashback Worth Rs.1,555.</p>
                                    <button type="button" class="btn btn-warning">Add to Cart</button>
                                    </div> 
